...
<head>
	<link rel="stylesheet" type="text/css" href="resources/css/hotel_list.css" />
	...
	<script>  
		...
		function SubmitSearch() {
		    ...
		    window.location.href = "hotel_list?city_no=" + city_no_search + "&prd_opt=" + prd_opt_search;
		}
